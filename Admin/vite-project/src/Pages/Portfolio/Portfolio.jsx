...
const Portfolio = () => {
  ...
  // Extra States for Image Management
      ...
      },
      {
        ...
        cell: (row) => (
          <div className="flex gap-2">
            <button
              onClick={() => handleEdit(row)}
              className="bg-amber-500 hover:bg-amber-600 text-white px-4 py-1 rounded text-sm"
            >
              Edit
            </button>
            <button
  ...
  <textarea
    ...
    className="w-full border p-3 rounded min-h-[100px] focus:ring-2 focus:ring-indigo-500"
    required
    disabled={loading}
    maxLength={100}
  ...
  <div className="text-right text-sm mt-1">
    <span className={`font-medium ${
      form.description.length > 80 ? "text-red-500" : 
      form.description.length > 60 ? "text-orange-500" : "text-gray-500"
    }`}>
      {form.description.length} / 100
        ...
        <div>
              ...
              <div className="flex flex-wrap gap-3">
                {existingImages.map((img, i) => (
                  <div key={i} className="relative">
                    <img src={img} alt="existing" className="w-24 h-24 object-cover rounded border" />
                    <button
                      type="button"
          ...
          {form.images?.length > 0 && (
            <div className="mt-4">
              <p className="font-medium mb-2 text-green-600">New Images:</p>
              <div className="flex flex-wrap gap-3">
